...
const REPEAT_WEIGHT_MULTIPLIER := 0.35
const STREAK_WEIGHT_MULTIPLIER := 0.15
const RECOVERY_DELAY := 20.0
const RECOVERY_RATE := 1.0
const TV_STARTUP_CUE_SECONDS := 2.6
const SLEEP_SETTLE_CUE_SECONDS := 4.0
const GOOD_PULSE_SECONDS := 0.35
